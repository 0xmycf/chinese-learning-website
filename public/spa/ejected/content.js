const allContent=[{pager:1,type:"index",path:"/",filepath:"content/index.json",filename:"index.json",fields:{title:"daai6gaa1hou2",intro:["This is the frontpage"]}},{pager:1,type:"test",path:"test/ipsum",filepath:"content/test/ipsum.json",filename:"ipsum.json",fields:{Header:"ipsum",Body:["Some simple body"]}},{pager:1,type:"test",path:"test/lorem",filepath:"content/test/lorem.json",filename:"lorem.json",fields:{Header:"Lorem",Body:[`Lorem ipsum dolor sit amet, consectetur adipiscing elit.
...
Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia curae; Pellentesque pharetra ex dui, consequat accumsan mauris condimentum sed.`,`Quisque aliquam justo malesuada eros pulvinar, non viverra ex sodales.
...
Nulla vitae augue id metus gravida rutrum.`]}}];export default allContent